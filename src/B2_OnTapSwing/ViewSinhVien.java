...
public class ViewSinhVien extends javax.swing.JFrame {
    ...
    public ViewSinhVien() {
        initComponents();
        // Muon chay chuong trinh => hien thi luon => Se viet trong contructor va duoi init
        lists = service.getAll(); // 5 phan tu 
    ...
    // show du lieu len table 
    private void showDataTable(List<SinhVien> listSinhVien) {
        tableModel.setRowCount(0);
        for (SinhVien sv : listSinhVien) {
            tableModel.addRow(new Object[]{sv.getTen(), sv.getLoai(), sv.isGioiTinh(), sv.getSoThich()});
        }
    }
    ...
    private void btnClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearActionPerformed
        ...
        buttonGroup1.clearSelection(); // xoa radio button dang chon 
        rdNam.setSelected(true);
